...
<img class="border-1 rounded-circle" style="object-fit: cover; width: 50px; height: 50px; border: solid 3px white;" src=<?php if (isset($user)) if ($user->getImagePath() == null) echo "./images/avatar/default.png"; else echo "./images/avatar/".$_SESSION["User_ID"]."/" . $user->getImagePath(); ?>>