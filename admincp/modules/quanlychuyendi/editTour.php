...
<div class="container" id="tour">
  ...
  <form id="editTourForm" method="POST" action="modules/quanlychuyendi/execute.php" enctype="multipart/form-data">
    ...
    <div class="form-group mt-3">
      ...
      <textarea style="resize: none;" rows="10" class="form-control" id="description"
        name="description"><?php echo $tour->getDescription() ?></textarea>
    </div>
    <div class="form-group mt-3">
      <label for="">Hình ảnh</label>
      <input style="border-bottom-left-radius: 0px ;border-bottom-right-radius: 0px;" type="file" class="form-control"
        id="imagePath" name="imagePath"
        src="<?php echo "../images/tour/" . $tour->getTourID() . "/" . $tour->getImagePath() ?>">
      <img id="currentImage" style="width: 100%; max-width: 100%;" class="border-3 border-top-0 rounded-bottom"
        src="<?php echo "../images/tour/" . $tour->getTourID() . "/" . $tour->getImagePath() ?>" width="100px" alt="">
    </div>
    <div id="notification" class="mt-3 alert alert-success alert-dismissible d-none" role="alert">Cập nhật chuyến đi
      thành công</div>
