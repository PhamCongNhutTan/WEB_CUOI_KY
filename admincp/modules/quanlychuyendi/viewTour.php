...
<div class="container" id="viewTour">
    <h3 style="text-align: left;" class="mt-3 "><span class="bar"></span>Quản lý chuyến đi</h3>
    ...
    <div class="mt-3">
        ...
        <select class="form-select rounded-3" style="width: 25%; padding: 4px;" name="type" id="" onchange="handleSelect(this);">
        ...
        <tbody>
            ...
            ?>
                <tr class="py-3">
                    ...
                    <td><?php echo $tour->getBasePrice() ?></td>
                    <td>
