        ...
        <tr>
          ...
          <td>
            <button type="button" class="btn btn-primary"> <a style="text-decoration:none; color:white;"
                href="?action=quanlytintuc&query=edit&post_id=<?php echo $row['post_id'] ?>"> Chỉnh sửa</a></button>
            <button type="button" class="btn btn-danger"><a style="text-decoration:none; color:white;"
                href="modules/quanlytintuc/excute.php?post_id=<?php echo $row['post_id'] ?>"> Xóa</a> </button>
          </td>
        </tr>
        <?php
      }
